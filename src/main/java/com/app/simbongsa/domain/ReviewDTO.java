...
public class ReviewDTO {
    ...
    @Builder
    public ReviewDTO(Long id, String boardTitle, String boardContent, LocalDateTime createdDate, LocalDateTime updatedDate, MemberDTO memberDTO, List<ReviewReply> reviewReplies, List<ReviewFile> reviewFiles) {
        this.id = id;
