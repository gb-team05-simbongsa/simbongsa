...
$('.content__detail__btn').on('click', function () {
    ...
    adminService.getDetail("/admins/funding-details", contentId, function(result) {
        ...
        // console.log(fileDTOs[0].filePath);
        ...
        //                     <img src="/file/display?fileName=` + fileDTO.filePath + `"/>
        //                 </div>
        //             </label>
        //                 `;
        // });
        // for(let i = 0; i < `${result.fileDTOs}`.length; i++) {
        //     text += `
        //             <label>
        //                 <div class="content__img">
        //                     <img src="/file/display?fileName=${result.fileDTOs[i].filePath}"/>
        //                 </div>
        //             </label>
        //                 `;
        // }
