...
//        for (int i = 0; i < 15; i++) {
//            FundingPayment fundingPayment1 = new FundingPayment(300, LocalDateTime.now(), memberRepository.findById(1L).get(),fundingRepository.findById(227L).get());
//            fundingPaymentRepository.save(fundingPayment1);
//        }
//
//        FundingPayment fundingPayment2 = new FundingPayment(500, LocalDateTime.now(), memberRepository.findById(1L).get(),fundingRepository.findById(227L).get());
