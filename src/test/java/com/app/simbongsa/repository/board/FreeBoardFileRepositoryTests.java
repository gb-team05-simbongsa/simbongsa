...
public class FreeBoardFileRepositoryTests {
    ...
    public void saveTest(){
        FreeBoardFile freeBoardFile1 = new FreeBoardFile("100" + ".png","48ew34ufeuods","c:/2023/document", FileRepresentationalType.REPRESENTATION,freeBoardRepository.findById(413L).get());
